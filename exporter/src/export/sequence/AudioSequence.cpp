...
void GetAudioSequence(const AEGP_ItemH& itemH, const std::string& outputPath,
  ...
  Suites->ItemSuite6()->AEGP_GetItemFlags(itemH, &flags);
  ...
  Suites->RenderSuite4()->AEGP_RenderNewItemSoundData(itemH, &workAreaStart, &workAreaDuration,
