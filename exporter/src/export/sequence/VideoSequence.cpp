...
#include "export/videoEncode/VideoEncoder.h"
...
static void RebuildVideoComposition(const std::shared_ptr<PAGExportSession>& session,
                                    pag::VideoComposition* composition,
...
void GetVideoSequence(const std::shared_ptr<PAGExportSession>& session,
                      std::vector<pag::Composition*>& compositions,
